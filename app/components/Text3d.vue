...
const inlineStyles = computed(
  (): CustomCSSProperties => ({
    ...
    '--after-shadow': props.enableShadows ? '-2px 0 #317ef2' : 'none',
    '--before-shadow': props.enableShadows ? '2px 0 #317ef2' : 'none'
  })
);
...
const normalGlitchClasses = [
  'after:[text-shadow:var(--after-shadow,-2px_0_#317ef2)]',
  'after:[animation:animate-glitch_var(--after-duration,3s)_infinite_linear_alternate-reverse]',

  'before:[text-shadow:var(--before-shadow,2px_0_#317ef2)]',
...
const hoverOnlyClasses = [
  ...
  'hover:before:[text-shadow:var(--before-shadow,2px_0_#317ef2)]',
  ...
  'hover:after:[text-shadow:var(--after-shadow,-2px_0_#317ef2)]',
